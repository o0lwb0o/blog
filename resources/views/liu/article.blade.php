        ...
        <div class="content-wrap">
            <div class="content">
                <header class="article-header">
                    <h1 class="article-title"><a href="#" title="{{$list->title}}" >{{$list->title}}</a></h1>
                    <div class="article-meta">
                        <span class="item article-meta-time">
	                        <time class="time" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="发表时间：@if(empty($list->uptime)){{date('Y-m-d',$list->addtime)}}@else{{date('Y-m-d',$list->uptime)}}@endif">
                            <i class="glyphicon glyphicon-time"></i> @if(empty($list->uptime)){{date('Y-m-d',$list->addtime)}}@else{{date('Y-m-d',$list->uptime)}}@endif</time>
                         </span>
                        <span class="item article-meta-source" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="来源：劉文彬的博客">
                            <i class="glyphicon glyphicon-globe"></i> 劉文彬的博客
                        </span>
                ...
                <div class="article-tags">标签：[{{$list->keyword}}]
                </div>
                <div class="relates">
                    <div class="title">
                        <h3>相关推荐</h3>
